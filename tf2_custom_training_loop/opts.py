...
parser.add_argument('--iter_epoch_ratio', type=float, default=0.3, help='# of ratio of total images as an epoch')
...
parser.add_argument('--data_path', type=str, default='', help='where dataset saved. See loader.py '
...
# parser.add_argument('--lr_decay_epoch', type=int, default=0.3, help='how many epoch to decay learning rate')
